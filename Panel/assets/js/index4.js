        ...
        dropShadow: {
            ...
            plotOptions: {
             ...
             fill: {
                ...
                gradient: {
                    shade: 'dark',
                    gradientToColors: [ '#8f50ff', '#0072ff', '#f1076f', '#08a50e', '#f7971e', '#fc00ff', '#000428', '#ba8b02', '#009efd', '#000000','#8f50ff', '#0072ff', '#f1076f'],
                    shadeIntensity: 1,
                    type: 'horizontal',
                    opacityFrom: 1,
                    opacityTo: 1,
            ...
            colors: ['#d13adf', '#00c8ff', '#ff5447', '#cddc35', '#ffd200', '#00dbde', '#004e92', '#181818', '#2af598', '#ffffff','#d13adf', '#00c8ff', '#ff5447'],
            dataLabels: {
                enabled: true,
                textAnchor: 'start',
                style: {
            ...
            series: [{
                data: [950, 730, 848, 570, 840, 580, 900, 1100, 1200, 1280,680,890]
            }],
            stroke: {
                width: 1,
              colors: ['#fff'],
            ...
            xaxis: {
                categories: ['E201','E202','E203','E204','E205','E206','E207','E208','E209','E210','E211','E212'],
            },
            yaxis: {
                labels: {
                    show: false
  ...
  // chart 6
    ...
    var options = {
           ...
           toolbar: {
            ...
            title: {
                text: 'Monthly Player Registration, 2023',
                floating: true,
                offsetY: 0,
                align: 'center',
                style: {
...
var options = {
          ...
          sparkline:{
            ...
            series: [{
                name: 'New Users',
                data: [15, 26, 20, 33, 27, 43, 17, 26, 19, 20]
            },{
                name: 'Returning Users',
                data: [33, 21, 42, 19, 32, 25, 36, 29, 49, 21]
            }],
