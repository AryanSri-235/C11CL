...
<!-- Mirrored from codervent.com/rukada/demo/vertical/ltr/auth-cover-forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 07:08:56 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
						...
						<div class="card rounded-0 m-3 shadow-none bg-transparent mb-0">
							<div class="card-body p-sm-5">
								...
								<form id="myForm" method="POST" class="row g-3" enctype="multipart/form-data" onsubmit="return validateForm()">
									...
									<p class="text-muted">Enter your registered email ID and phone number to reset the password</p>
									<div class="my-4">
									    <h5>
											<?php if (isset($denied)) {
												echo $denied;
									...
									<div class="my-4">
										<label class="form-label">Phone Number (10 Digit)</label>
										<input type="number" name="number" class="form-control" placeholder="9999999999" />
										<span id="showerror" style="color:red"></span>
									</div>
									<div class="d-grid gap-2">
										<button type="submit" class="btn btn-primary" name="forgotpassword">Send</button>
										<a href="login.php" class="btn btn-light"><i class='bx bx-arrow-back me-1'></i>Back to
											Login</a>
									</div>
								</form>	
								</div>
...
<!-- Mirrored from codervent.com/rukada/demo/vertical/ltr/auth-cover-forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 07:08:57 GMT -->
</html>