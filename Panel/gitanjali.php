...
echo "<tr $rowStyle>
  ...
  <td class='text-center'>
        " . ($isSuccess 
            ...
            : "<a href='../send.php?id=" . $row['id'] . "' 
                  onclick='return confirm(\"Are you sure you want to mark this player as Success?\")' 
                  class='btn btn-xs btn-warning' 
                  style='font-size:10px; font-weight:800; padding:2px 8px; border-radius:4px; text-transform:uppercase;'>Mark Success</a>") . "
    </td>

    <td class='text-end' style='width:50px;'>
        " . (!$isSuccess 
            ? "<button class='btn btn-link text-danger p-0 delete-btn' data-id='" . $row['id'] . "'>
