            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                      <?php
// Universal search and date filter
$datef = $_POST['datef'] ?? '';
$datel = $_POST['datel'] ?? '';
...
if ($result && $result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $statusBadge = $row['status'] === 'Success' ? '<span class="badge-success">Success</span>' : '<span class="badge-danger">Pending</span>';
        ...
        echo "<tr>
            ...
            <td>
                <a href=\"#\" class=\"openModal\" data-details='" . htmlspecialchars(json_encode($row), ENT_QUOTES) . "'>
                    <strong style='color:#007bff'>" . htmlspecialchars($row['reg'] ?? '', ENT_QUOTES) . "</strong>
                </a>
            </td>
