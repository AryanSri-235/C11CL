                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            // Default query
                            $sql = "SELECT * FROM verified_submissions ORDER BY submitted_at DESC LIMIT 50";
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                if (!empty($datef) && !empty($datel)) {
                                    $sql = "SELECT * FROM verified_submissions WHERE submitted_at BETWEEN '$datef 00:00:00' AND '$datel 23:59:59' ORDER BY submitted_at DESC";
                                } elseif (!empty($datef)) {
                                    $sql = "SELECT * FROM verified_submissions WHERE submitted_at >= '$datef 00:00:00' ORDER BY submitted_at DESC";
                                } elseif (!empty($datel)) {
                                    $sql = "SELECT * FROM verified_submissions WHERE submitted_at <= '$datel 23:59:59' ORDER BY submitted_at DESC";
                                }
                            }
