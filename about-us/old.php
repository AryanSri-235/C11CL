...
<body itemtype='https://schema.org/WebPage' itemscope='itemscope'
            ...
            <div class="ast-container">
                ...
                <div id="primary" class="content-area primary">
                    ...
                    <main id="main" class="site-main">
                        <article class="post-1255 page type-page status-publish ast-article-single" id="post-1255"
                            itemtype="https://schema.org/CreativeWork" itemscope="itemscope">

                            <header class="entry-header ast-no-title ast-header-without-markup">
                            </header> <!-- .entry-header -->
                            <div
                                style="font-family: 'Poppins', Arial, sans-serif; background-color: #ffffff; color: #333; line-height: 1.6;">
    ...
    <p style="max-width: 750px; margin: 0 auto; font-size: 1.1rem; color: #555;">
        Champions 11 Cricket League (C11CL) is more than a tournament — it’s a national
        movement to bring grassroots cricket talent into the spotlight.
        We empower young players with professional exposure and a fair shot at
        greatness.
    </p>
</div>
                                ...
                                <div
                                    style="max-width: 1100px; margin: 0 auto; padding: 80px 20px; display: flex; flex-wrap: wrap; align-items: center;">
                                    <div style="flex: 1; min-width: 300px; padding-right: 50px;">
                                        <h2
                                            style="font-size: 2.2rem; font-weight: 700; color: #111; margin-bottom: 20px;">
                                            Our Story</h2>
                                        <p style="font-size: 1.05rem; color: #444;">
                                            Founded in 2025, C11CL was born from the idea that India’s cricketing gems
                                            aren’t just found in stadiums — they’re in every alley, playground, and
                                            small town.
                                            We conduct <strong>open state-wise trials</strong> and offer a structured
                                            path to national recognition.
                                        </p>
                                        <p style="font-size: 1.05rem; color: #444;">
                                            Our process is built on <strong>transparency</strong>,
                                            <strong>performance-based selection</strong>, and <strong>equal
                                                opportunity</strong> for all.
                                            We are setting a new benchmark for how cricket is scouted and celebrated.
                                        </p>
                                    </div>
                                    <div style="flex: 1; min-width: 300px; text-align: center;">
                                        <img src="https://c11cl.com/wp-content/uploads/2025/06/Lucid_Realism_An_inspiring_side_view_scene_showing_a_cricket_c_0.jpg"
                                            alt="C11CL Story"
                                            style="width: 100%; max-width: 450px; border-radius: 15px; box-shadow: 0 15px 35px rgba(0,0,0,0.1);">
                                    </div>
                                </div>

                                <div style="background-color: #f9f9f9; padding: 80px 20px;">
                                    <div style="max-width: 1100px; margin: 0 auto;">
                                        <div style="text-align: center; margin-bottom: 50px;">
                                            <span
                                                style="color: #e31e24; font-weight: 700; text-transform: uppercase;">Why
                                                We Exist</span>
                                            <h2 style="font-size: 2.2rem; margin: 10px 0;">The Heart Behind C11CL</h2>
                                        </div>

                                        <div
                                            style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 40px;">
                                            <div
                                                style="background: #fff; padding: 40px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); text-align: center;">
                                                <img src="https://c11cl.com/wp-content/uploads/2025/06/our-vision.jpg"
                                                    alt="Vision"
                                                ...
                                                <p style="color: #666; font-size: 0.95rem;">To become India’s most
                                                    trusted grassroots cricket league. We envision a future where talent
                                                    is the only ticket forward, without politics or financial barriers.
                                                </p>
                                            </div>
                                            <div
                                                style="background: #fff; padding: 40px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); text-align: center;">
                                                <img src="https://c11cl.com/wp-content/uploads/2025/06/values.jpg"
                                                    alt="Values"
                                                    style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; margin-bottom: 20px;">
                                                <h3 style="font-size: 1.5rem; margin-bottom: 15px;">💬 Our Values</h3>
                                                <p style="color: #666; font-size: 0.95rem;">Discipline, Dedication, and
                                                    Diversity. We believe in shaping character and creating equal
                                                    chances for everyone, whether they come from a city or a village.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    style="max-width: 1000px; margin: 0 auto; padding: 80px 20px; display: flex; flex-wrap: wrap; align-items: center;">
                                    <div style="flex: 1; min-width: 300px; text-align: center;">
                                        <img src="https://c11cl.com/wp-content/uploads/2025/09/Screenshot-2025-09-21-182224.png"
                                            alt="Ruchi Gautam Pant"
                                            style="width: 100%; max-width: 350px; border-radius: 10px; border: 5px solid #fff; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
                                    </div>
                                    <div style="flex: 1.5; min-width: 300px; padding: 20px 40px;">
                                        <h2 style="font-size: 2rem; margin-bottom: 5px;">Ruchi Gautam Pant</h2>
                                        <h4 style="color: #e31e24; margin-bottom: 20px;">Founder and CEO</h4>
                                        <p style="font-size: 1rem; color: #555; line-height: 1.8;">
                                            Ruchi Gautam Pant is the visionary force behind C11CL. With a deep passion
                                            for sports and youth development, she laid the foundation to create a
                                            transparent and empowering platform for aspiring cricketers. Her leadership
                                            reflects inclusivity and commitment to grassroots talent.
                                        </p>
                                        <img src="https://c11cl.com/wp-content/uploads/2025/07/signature-3.png"
                                            alt="Signature" style="width: 180px; margin-top: 20px;">
                                    </div>
                                </div>

                                <div
                                    style="background-color: #1a1a1a; color: #ffffff; padding: 80px 20px; text-align: center;">
                                    <h2 style="font-size: 2.2rem; color:white; margin-bottom: 40px;">What We Do</h2>
                                    <div
                                        style="max-width: 1100px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(230px, 1fr)); gap: 20px;">
                                        <div style="background: #222; padding: 30px; border-radius: 8px;">
                                            <h4 style="color: #e31e24;">Transparent Selections</h4>
                                            <p style="font-size: 0.9rem; color: #bbb;">Open trials in every state to
                                                ensure talent is discovered fairly — no favoritism.</p>
                                        </div>
                                        <div style="background: #222; padding: 30px; border-radius: 8px;">
                                            <h4 style="color: #e31e24;">Professional Setup</h4>
                                            <p style="font-size: 0.9rem; color: #bbb;">Printed jerseys, kits, and
                                                professional scoring for a league-like experience.</p>
                                        </div>
                                        <div style="background: #222; padding: 30px; border-radius: 8px;">
                                            <h4 style="color: #e31e24;">National Stage</h4>
                                            <p style="font-size: 0.9rem; color: #bbb;">Pathway from state trials to
                                                national matches, gaining visibility and career opportunities.</p>
                                        </div>
                                        <div style="background: #222; padding: 30px; border-radius: 8px;">
                                            <h4 style="color: #e31e24;">Community & Sponsors</h4>
                                            <p style="font-size: 0.9rem; color: #bbb;">Trusted partners who support our
                                                mission to scale and impact more players.</p>
                                        </div>
                                    </div>
                                </div>

                                <div style="text-align: center; padding: 60px 20px; background: #fff;">
                                    <h2 style="margin-bottom: 10px;">Happy Faces of Happy Players</h2>
                                    <p style="color: #666; margin-bottom: 30px;">Behind every smile, there’s a story of
                                        hustle, hope, and hard work.</p>
                                    <a href="../testimonials/index.html"
                                        style="background: #e31e24; color: #fff; padding: 15px 35px; text-decoration: none; font-weight: bold; border-radius: 5px; display: inline-block; transition: 0.3s;">View
                                        All Testimonials</a>
                                </div>
