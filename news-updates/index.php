...
<div style="padding-bottom:15px" class="col-lg-4 col-md-6 mb-4">
    <div class="elementskit-post-image-card">
        <div class="elementskit-entry-header">
            <a href="<?php echo $post_url; ?>" class="elementskit-entry-thumb">
                <div class="elementskit-entry-thumb">
                    <img style="width:100%; height: 250px; object-fit: cover;" src="<?php echo $img_src; ?>" 
        ...
        <div class="elementskit-post-body">
            <div class="post-meta-list" style="font-size: 13px; margin-bottom: 8px;">
                <span><i aria-hidden="true" class="icon icon-user"></i> <?php echo htmlspecialchars($row['author']); ?></span>
                <span style="margin-left:15px;"><i aria-hidden="true" class="icon icon-folder"></i> <?php echo htmlspecialchars($row['category']); ?></span>
            </div>
            <a href="<?php echo $post_url; ?>">
                <h2 class="entry-title" style="font-size: 18px; line-height: 1.4; margin-top: 8px;">
