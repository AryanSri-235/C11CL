...
$sql = "UPDATE register SET age = '$age', player = '$player', state = '$state', city = '$city', ref = '$ref' WHERE reg = '$reg'";
        $con->query($sql);
        $_SESSION['payreg'] = $reg;
        //echo $reg . $age . $player;
       header('Location: ../reg-fee/pay.php');
        exit(); 
        } 
    }
...
$sql = "INSERT INTO register (name, reg,  age, mobile, email, player, state, city, ref, date, regCount, status)
VALUES ('$name', '$reg', '$age', '$mobile', '$email', '$player', '$state', '$city', '$ref','$date', '$regCount', 'Pending')" ;
